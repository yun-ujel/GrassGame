...
namespace GrassGame.Gameplay.Synced
{
    public class PlayerSync : NetworkBehaviour
    {
        ...
        public NetworkVariable<CharacterType> characterType = new(CharacterType.Jackson, NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Owner);
